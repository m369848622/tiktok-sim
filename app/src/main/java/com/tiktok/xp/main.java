...
//                super.afterHookedMethod(param);
        ...
        Class NetworkInterface = classLoader.loadClass("java.net.NetworkInterface");
...
//        Class ConnectivityManager = classLoader.loadClass("java.net.ConnectivityManager");
//        XposedHelpers.findAndHookMethod(ConnectivityManager, "getNetworkCapabilities", new XC_MethodHook() {
//            @Override
//            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
////                super.afterHookedMethod(param);
